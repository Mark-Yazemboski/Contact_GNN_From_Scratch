...
save_model_path = os.path.join(script_dir, f"models/{Used_Num_train_trajectories}_train{extra_name}/{Used_Num_train_trajectories}_train_gns_model.pt")
...
inference_model_path = os.path.join(script_dir, f"models/{Used_Num_train_trajectories}_train{extra_name}/{Used_Num_train_trajectories}_train_gns_model_best_model.pt")
