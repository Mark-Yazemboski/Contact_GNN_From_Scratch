...
trajectory_folder = os.path.join(script_dir, "data/tosses_processed")  # Folder where the trajectory .pt files are stored
...
Train = True
#------------------------------------------------------------------------------------------------------
model_folder_path = os.path.join(script_dir, f"models/Paper_Error_Plots")
